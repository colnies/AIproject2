...
/**
 * A MIRA object can classify images given a training set. It uses the following
...
public class MIRA {
	...
	/**
	 * creates a MIRA object and trains it on the given trainingSet
	 * @param trainingSet
	 * @param testingSet
	 */
	public MIRA(ArrayList<Image> trainingSet, ArrayList<Image> testingSet ){
	...
	/**
	 * creates a MIRA object and trains it on a percentage of the training set indicated 
	 ...
	 * 0 <= percent <= 1
	 */
	public MIRA(boolean isFaceType, double percent){
	...
	//each label until they are no longer updated or 4 sec has passed. returns the 
